...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		...
		remote: "Le champ n'est pas correct.",
		...
		accept: "<br/>Merci de mettre un fichier avec format valide.",
	...
	messages: {
	  ...
	  dateISO: "Please enter a valid date (ISO).",
	  dateDE: "Bitte geben Sie ein gültiges Datum ein.",
	  number: "Veuillez saisir un numero valide.",
	  numberDE: "Bitte geben Sie eine Nummer ein.",
	  digits: "Entrez nombres seulement",
	  creditcard: "Veuillez saisir un numero de carte valide",
	  equalTo: "Veuillez saisir une seconde fois la même valeur.",
	  accept: "Veuillez entrer une valeur avec with a valid extension.",
	  maxlength: $.validator.format("Vous ne pouvez saisir que {0} des caractères."),
	  minlength: $.validator.format("Veuillez saisir au moins {0} caractères."),
	  rangelength: $.validator.format("Veuillez saisir un texte de X et Y caractères."),
	  range: $.validator.format("Vous ne pouvez saisir que de nombres compris entre {0} et {1}."),
