...
MySQL - 5.5.8 : Database - artyfrag_fragance
*********************************************************************
*/
...
insert  into `detallearticulo`(`idDetalleArticulo`,`idArticulo`,`titulo`,`tituloDetalle`,`parrafoDetalle`,`fotoPrincipalDetalle`,`slugDetalle`,`estado`) values (4,2,'Presentation1111','','<p>\r\n	<u>Cour is the best way in all the word in thw worddaa</u></p>\r\n','presentation.jpg','presentation','0'),(5,2,'dasdas ','dasdasd','fds fslfksd ','fdas.jpf','fsdf','0');
