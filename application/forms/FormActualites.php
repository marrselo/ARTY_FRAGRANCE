...
class Application_Form_FormActualites extends Zend_Form {
    ...
    public function init() {
        ...
        $e = new Zend_Form_Element_Text('titleActualites');
        $e->setRequired(true);
        $this->addElement($e);
        $e = new Zend_Form_Element_Textarea('contenidoActualites');
        $e->setRequired(true);
        $this->addElement($e);
        $element = new Zend_Form_Element_File('imagen');
        $element->setLabel('Cargar Imagen:')
                ->setRequired()
                ->setDestination($confUpload["rutaActualites"]);
