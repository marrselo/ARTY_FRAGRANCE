...
class Admin_SitesController extends ZExtraLib_Controller_Action {
    ...
    public function adminPageAction() {
        ...
        $this->view->listaMenu = $modelMenu->listarMenuCms(10, $this->sessionAdmin->idiomaDetaful['idIdioma']);
    }
    public function adminPageLiensAmisAction() {
        $this->view->modulo = 5;
        $modelMenu = new Application_Model_Menu();
        $this->view->listaMenu = $modelMenu->listarMenuCms(5, $this->sessionAdmin->idiomaDetaful['idIdioma']);
    }
